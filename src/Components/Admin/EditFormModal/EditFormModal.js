...
function EditModalDialog(props) {
  ...
  const UpdateMovieAction = async (e) => {
    ...
    const token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MmRiN2Q3MDljMGQxZDA4NjA5ZjUzY2EiLCJtYUxvYWlOZ3VvaUR1bmciOiIwIiwiaWF0IjoxNjY1NTkyNzQzLCJleHAiOjE2NjU1OTYzNDN9.KIUDS3J_XmcIPrSaSZfSVljlDcRHPRNDKQJIgJk9Ph0";
      ...
      <Modal size="lg" show={isShow}>
        ...
        <Modal.Body>
              ...
              <Input
                ...
                value={
                  isEdit
                    ...
                    : new Date(data.detailMovie?.ngayKhoiChieu).toDateString()
                }
                label="Khởi chiếu"
                name="ngayKhoiChieu"
          ...
          <div className="row">
            <div className="col-md-5">
              <Input
                type={isEdit ? "hidden" : "text"}
                value={
                  data.detailMovie?.ngayKetThuc
                    ? new Date(data.detailMovie?.ngayKetThuc).toDateString()
                    : "Chưa có thông tin"
                }
